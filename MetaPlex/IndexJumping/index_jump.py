...
def calculate_IJR(demultiplexed_seqs, sample_map, calibrator_tag_pairs):
    '''
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4:
        calculate_IJR(sys.argv[1], sys.argv[2], calibrator_tag_pairs=None)
        ...
        for i in range(3, len(sys.argv)):
            ...
            calculate_IJR(sys.argv[1], sys.argv[2], c_tags_list)
